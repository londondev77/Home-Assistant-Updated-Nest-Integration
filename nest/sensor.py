...
class TemperatureSensor(SensorBase):
    ...
    def native_value(self) -> float:
        ...
        #Comment out following line and uncomment out the next line if you want the current temperature sensor to round to the nearest 0.5
        return float(round(trait.ambient_temperature_celsius, 1))
        #return round(trait.ambient_temperature_celsius * 2) / 2
